...
public class App 
{
    ...
    {
        System.out.println( "Hello batch DP060419..!" );
...
//        System.out.println("myObject: " + myObject.toString());
         ...
         */
        System.out.println("We're ignoring the above error... but thankfully, Checker has our back: http://checkerframework.org");
    }
}
